...
<html>
  ...
  <body>
    ...
    <hr/>
      <div class="row">
        <form class="form" action="insertprod.php" method="POST" enctype="multipart/form-data" autocomplete="on">
          ...
          <div class="form-group">
            <label for="text">Product Headline :</label>
              <input type="text" class="form-control" id="username" name="prodname">
          </div>
          <div class="form-group">
            <label for="text">Short Description :</label>
              <textarea rows="3" class="form-control" id="username" name="shortdesc"></textarea>
          </div>
          <div class="form-group">
            <label for="text">Full Description :</label>
              <textarea rows="9" class="form-control" id="username" name="fulldesc"></textarea>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="text">Actual Rate ( in Rs.):</label>
              <input type="text" class="form-control" id="username" name="actrate">
          </div>
          <div class="form-group">
            <label for="text">Effective Rate ( in Rs.):</label>
              <input type="text" class="form-control" id="username" name="effrate">
          </div>
          <div class="form-group">
            <label for="text">Discount  ( in %):</label>
              <input type="text" class="form-control" id="username" name="discount">
          </div>
          <div class="form-group">
            <label for="text">Offers / Warranty / Extra Services</label>
              <input type="text" class="form-control" id="username" name="offers">
          </div>
          <div class="form-group">
            <label for="text">Products sold : (QUANTITY (numbers))</label>
              <input type="text" class="form-control" id="username" name="soldquantity">
          </div>
          <div class="form-group">
